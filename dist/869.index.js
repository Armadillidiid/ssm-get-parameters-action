...
var client = __webpack_require__(2000);
var tokenProviders = __webpack_require__(9416);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4736); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(6923);
...
const httpAuthSchemes_1 = __webpack_require__(9347);
...
const bdd_1 = __webpack_require__(2767);
...
var middlewareUserAgent = __webpack_require__(5907);
...
var middlewareRetry = __webpack_require__(7561);
var smithyClient = __webpack_require__(3684);
var httpAuthSchemeProvider = __webpack_require__(4996);
var runtimeConfig = __webpack_require__(7981);
...
var errors = __webpack_require__(3656);
var SSOServiceException = __webpack_require__(3169);
...
const SSOServiceException_1 = __webpack_require__(3169);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9434));
const client_1 = __webpack_require__(2000);
const httpAuthSchemes_1 = __webpack_require__(9347);
const util_user_agent_node_1 = __webpack_require__(5905);
...
const util_retry_1 = __webpack_require__(4702);
const runtimeConfig_shared_1 = __webpack_require__(5922);
...
exports.getRuntimeConfig = void 0;
const httpAuthSchemes_1 = __webpack_require__(9347);
const protocols_1 = __webpack_require__(4744);
...
const httpAuthSchemeProvider_1 = __webpack_require__(4996);
const endpointResolver_1 = __webpack_require__(8714);
...
const errors_1 = __webpack_require__(3656);
const SSOServiceException_1 = __webpack_require__(3169);
...
var client = __webpack_require__(2000);
var httpAuthSchemes = __webpack_require__(9347);
var propertyProvider = __webpack_require__(7930);
var sharedIniFileLoader = __webpack_require__(9498);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 83).then(__webpack_require__.t.bind(__webpack_require__, 5083, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 83).then(__webpack_require__.t.bind(__webpack_require__, 5083, 23));
